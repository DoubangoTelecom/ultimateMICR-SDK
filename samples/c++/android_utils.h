#if !defined(_ULTIMATE_MICR_SDK_SAMPLES_ANDROID_UTILS_H_)
#define _ULTIMATE_MICR_SDK_SAMPLES_ANDROID_UTILS_H_

#include <ultimateMICR-SDK-API-PUBLIC>

#if ULTMICR_SDK_OS_ANDROID // below code come from https://github.com/DoubangoTelecom/compv/blob/master/api/include/compv/compv_api.h
...
#endif /* _ULTIMATE_MICR_SDK_SAMPLES_ANDROID_UTILS_H_ */
