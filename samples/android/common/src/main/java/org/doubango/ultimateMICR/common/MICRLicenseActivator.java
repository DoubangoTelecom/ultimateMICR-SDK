 ...
 * License activator.
 */
public class MICRLicenseActivator {

    /**
     * TAG used for the debug logs.
     */
    static final String TAG = MICRLicenseActivator.class.toString();
     ...
     */
    static final String LICENSE_TOKEN_FILE_NAME = "ultimateMICR-token.lic";
            ...
            return Executors.newSingleThreadExecutor().submit(new Callable<String>() {
                ...
                public String call() throws Exception {
                    ...
                    try {
                        ...
                        final UltMicrSdkResult result = UltMicrSdkEngine.requestRuntimeLicenseKey(true);
                        if (!result.isOK()) {
