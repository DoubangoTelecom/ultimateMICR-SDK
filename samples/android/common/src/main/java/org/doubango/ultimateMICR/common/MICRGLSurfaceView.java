 ...
 * GL surface view
 */
public class MICRGLSurfaceView extends GLSurfaceView implements GLSurfaceView.Renderer {
    private static final String TAG = MICRGLSurfaceView.class.getCanonicalName();
    ...
    public MICRGLSurfaceView(android.content.Context context) {
        super(context);
        initGL();
    }

    public MICRGLSurfaceView(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        initGL();
    }
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        final MICRUtils.MICRTransformationInfo tInfo = new MICRUtils.MICRTransformationInfo(swapSize ? imageHeight : imageWidth, swapSize ? imageWidth : imageHeight, getWidth(), getHeight());
